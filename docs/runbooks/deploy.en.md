# Runbook — sdkwork-order deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-order-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-order/bundle`, loads the image, starts
