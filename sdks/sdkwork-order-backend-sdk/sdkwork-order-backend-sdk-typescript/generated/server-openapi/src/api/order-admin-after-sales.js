...
export class OrderAdminAfterSalesAfterSalesManagementApi {
    ...
    async list(params, requestOptions) {
        ...
        return this.client.request(appendQueryString(backendApiPath(`/after_sales/requests`), query), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'GET', sdkworkUnwrapKind: 'page' });
    }
...
export function createOrderAdminAfterSalesApi(client) {
...
//# sourceMappingURL=order-admin-after-sales.js.map