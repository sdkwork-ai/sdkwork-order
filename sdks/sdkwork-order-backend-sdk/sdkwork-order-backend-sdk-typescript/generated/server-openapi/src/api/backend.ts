...
/** Token Bank plans retire. */
  async retire(planCode: string, params: BackendTokenBankPlansRetireParams, body?: unknown, requestOptions?: ApiRequestOptions): Promise<SdkWorkCommandData> {
    const requestHeaders = buildRequestHeaders(
      {
        'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
      },
...
/** Account value packages retire. */
  async retire(packageId: string, params: BackendAccountValuePackagesRetireParams, body?: unknown, requestOptions?: ApiRequestOptions): Promise<SdkWorkCommandData> {
    const requestHeaders = buildRequestHeaders(
      {
        'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
      },
