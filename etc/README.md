# sdkwork-order Source Configuration
...
| `appId` | `sdkwork-order` |
| `runtimeCode` | `order` |
| Config root | `/etc/sdkwork/order/` |
| Runtime TOML | `/etc/sdkwork/order/config.toml` |
| Secrets | `/etc/sdkwork/order/secrets/` |
| Override | `SDKWORK_ORDER_CONFIG_FILE` |
